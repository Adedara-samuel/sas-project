...
export default function DashboardNav() {
    ...
    return (
        <nav className="bg-white shadow-sm sticky top-0 z-50 border-b border-gray-100"> {/* Light background, subtle shadow, light border */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-6">
                        ...
                        {/* User Avatar - now a Link to profile */}
            ...
            {isOpen && (
                <div className="md:hidden border-b border-gray-100 pb-4" id="mobile-menu">
                    <div className="px-2 pt-2 space-y-1 sm:px-3">
                        ...
                        {/* User Initial for mobile, as a link to profile */}
